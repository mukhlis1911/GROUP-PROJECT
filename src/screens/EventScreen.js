  ...
  render() {
    return (
      <Container>
        ...
        <View style={{height:200, width: 300, marginBottom:30, alignSelf: 'center', marginTop: 20, backgroundColor:"lightgrey", borderRadius:10}}>
      ...
      <View style={{height:250, width: 300, marginBottom:30, alignSelf: 'center', marginTop: 20, backgroundColor:"lightgrey", borderRadius:10}}>
